  ...
  return (
    <div className="container mx-auto px-7 bg-background">
        <div className="flex flex-col items-center">
            ...
            <Button size={"lg"} className="cursor-pointer bg-blue-600 hover:bg-blue-200 hover:text-slate-700 active:scale-125 transition-transform dark:text-white dark:hover:text-slate-700 mb-20">Get Started</Button>
